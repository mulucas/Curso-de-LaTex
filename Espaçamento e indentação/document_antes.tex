...
\setlength{\parindent}{2cm}%indenta a margem da primeira linha
...
\vspace{2cm}% o 'v' é de vertical e space de espaço
%\onehalfspacing espaçamento 1,5
%\setstretch{3}espaçamento 3
%\doublespacing espaçamento double
...
\end{doublespace}
\newpage
\begin{spacing}{3}%espaçamento personalizado
