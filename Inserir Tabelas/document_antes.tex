...
\begin{document}	
	\title{\textbf{{\Huge Inserir Tabelas}}} % Título
	\author{Lucas Queiroz} % Autor
	\date{} % Data
	...
	% \usepackage[normalem]{ulem}-----------tablegerenate.com--------
	% \useunder{\uline}{\ul}{}
	\begin{table}[H]
		\centering
		\caption[leganda Curta]{Leganda longa}
		\label{tab:tab1}
		\begin{tabular}{l|l|l}
			\textit{\textbf{{\LARGE A1}}} & \textit{\textbf{B1}} & \textit{\textbf{C1}} \\ \hline
			\underline{A2}             &                      &                      \\ \hline
			A3             &                      &                     
		\end{tabular}
	\end{table}	
