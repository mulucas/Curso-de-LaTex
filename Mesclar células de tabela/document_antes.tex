...
\begin{document}	
	\title{\textbf{{\Huge Escalonar e alterar margem de tabelas}}} % Título
	...
	\begin{table}[H]
		...
		\label{tab:tab2}
		\begin{tabular}{|
				>{\columncolor[HTML]{38FFF8}}l |l|l|}
			\hline
			\textit{\textbf{A1}} & \multicolumn{2}{l|}{\cellcolor[HTML]{FD6864}\textit{\textbf{B1}}} \\ \hline
			{A2}             &                                 &                                 \\ \hline
			{A3}             &                                 &                                 \\ \hline
		\end{tabular}
	\end{table}
